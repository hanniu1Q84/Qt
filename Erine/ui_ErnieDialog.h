...
public:
    ...
    void setupUi(QDialog *ErnieDialog)
    {
        ...
        m_labName = new QLabel(ErnieDialog);
...
#endif
        m_labName->setPalette(palette);
        m_labName->setAutoFillBackground(true);
        m_labName->setFrameShape(QFrame::Panel);
        m_labName->setFrameShadow(QFrame::Sunken);

        horizontalLayout_2->addWidget(m_labName);

        m_labClock = new QLabel(ErnieDialog);
        m_labClock->setObjectName(QString::fromUtf8("m_labClock"));
        QPalette palette1;
        palette1.setBrush(QPalette::Active, QPalette::WindowText, brush);
        QBrush brush10(QColor(138, 226, 52, 255));
        brush10.setStyle(Qt::SolidPattern);
        palette1.setBrush(QPalette::Active, QPalette::Button, brush10);
        QBrush brush11(QColor(198, 255, 143, 255));
        brush11.setStyle(Qt::SolidPattern);
        palette1.setBrush(QPalette::Active, QPalette::Light, brush11);
        QBrush brush12(QColor(168, 240, 97, 255));
        brush12.setStyle(Qt::SolidPattern);
        palette1.setBrush(QPalette::Active, QPalette::Midlight, brush12);
        QBrush brush13(QColor(69, 113, 26, 255));
        brush13.setStyle(Qt::SolidPattern);
        palette1.setBrush(QPalette::Active, QPalette::Dark, brush13);
        QBrush brush14(QColor(92, 151, 34, 255));
        ...
        QBrush brush15(QColor(196, 240, 153, 255));
...
#endif
        m_labClock->setPalette(palette1);
        m_labClock->setAutoFillBackground(true);
        m_labClock->setFrameShape(QFrame::Panel);
        m_labClock->setFrameShadow(QFrame::Sunken);

        horizontalLayout_2->addWidget(m_labClock);


        verticalLayout->addLayout(horizontalLayout_2);

        m_fmPhoto = new QFrame(ErnieDialog);
        m_fmPhoto->setObjectName(QString::fromUtf8("m_fmPhoto"));
        QSizePolicy sizePolicy(QSizePolicy::Preferred, QSizePolicy::Expanding);
        sizePolicy.setHorizontalStretch(0);
        sizePolicy.setVerticalStretch(0);
        sizePolicy.setHeightForWidth(m_fmPhoto->sizePolicy().hasHeightForWidth());
        m_fmPhoto->setSizePolicy(sizePolicy);
        m_fmPhoto->setFrameShape(QFrame::Box);
        m_fmPhoto->setFrameShadow(QFrame::Raised);

        verticalLayout->addWidget(m_fmPhoto);
        ...
        m_btnStart = new QPushButton(ErnieDialog);
    ...
    {
        ErnieDialog->setWindowTitle(QApplication::translate("ErnieDialog", "ErnieDialog", nullptr));
        m_labName->setText(QString());
        m_labClock->setText(QString());
        m_btnStart->setText(QApplication::translate("ErnieDialog", "Start", nullptr));
    } // retranslateUi

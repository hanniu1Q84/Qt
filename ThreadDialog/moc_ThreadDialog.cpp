...
QT_MOC_LITERAL(4, 59, 21) // "on_QuitButton_clicked"

    },
    "ThreadDialog\0on_StartButton_clicked\0"
    "\0on_StopButton_clicked\0on_QuitButton_clicked"
};
...
void ThreadDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ThreadDialog *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject ThreadDialog::staticMetaObject = { {
    &QDialog::staticMetaObject,
    qt_meta_stringdata_ThreadDialog.data,
    qt_meta_data_ThreadDialog,
    qt_static_metacall,
    nullptr,
    nullptr
} };
